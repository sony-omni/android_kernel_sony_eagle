...
#include <mach/cci_hw_id.h>/* KevinA_Lin, 20130806 */ 
...
struct gpio_button_data {
	...
	struct wake_lock gpio_keys_wake_lock;/* KevinA_Lin, 20131206 */ 
...
static void gpio_keys_gpio_report_event(struct gpio_button_data *bdata)
{
	...
	if (type == EV_ABS) {
		...
		wake_lock_timeout(&bdata->gpio_keys_wake_lock, HZ*3);/* KevinA_Lin, 20131206 */ 
